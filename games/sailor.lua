...
-- Gabungan ArcX + NovaLib methods + Auto Skills FIXED
...
local function useSkills()
    local now = tick()
    if now - getgenv().Config.LastSkillTime < getgenv().Config.SkillCooldown then return end
...
print("✅ Auto Skills (Z,X,C,V,F) - FIXED")
